...
import org.example.productservice.shared.constant.ErrorMessage;
import org.example.productservice.shared.constant.PaginationConstant;
import org.example.productservice.shared.constant.SuccessMessage;
import org.example.productservice.shared.entity.Product;
import org.example.productservice.shared.exception.InvalidRequestParamException;
import org.example.productservice.shared.exception.MalformedFileException;
import org.example.productservice.shared.exception.NotFoundException;
import org.example.productservice.shared.global.*;
import org.example.productservice.shared.util.MessageSourceUtil;
...
//    @Override
//    public GlobalResponseDTO<NoPaginatedMeta, Void> importExcel(ImportDataRequestDTO request) {
...
//
//    @Override
//    public GlobalResponseDTO<NoPaginatedMeta, Void> importCsv(ImportDataRequestDTO request) {
//        if (ExcelUtil.notHasExcelFormat(request.file()))
//            throw new MalformedFileException(ErrorMessage.Request.MALFORMED_FILE);
//
//        try {
...
//    }
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> updateOne(
            Integer id,
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> hardDeleteOne(Integer id) {
        Optional<Product> found = productRepository.findById(id);
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> hardDeleteList(ListIdsRequestDTO request) {
...
//    @Override
//    public GlobalResponseDTO<NoPaginatedMeta, Void> updateListFromExcel(ImportDataRequestDTO request) {
//        if (ExcelUtil.notHasExcelFormat(request.file()))
//            throw new MalformedFileException(ErrorMessage.Request.MALFORMED_FILE);
//
//        try {
...
//    }
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> hideOne(Integer id) {
        Optional<Product> found = productRepository.findById(id);
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> hideList(ListIdsRequestDTO request) {
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> restoreOne(Integer id) {
        Optional<Product> found = productRepository.findById(id);
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> restoreList(ListIdsRequestDTO request) {
        List<Product> foundProducts = productRepository.findAllById(request.ids());
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> exposeOne(Integer id) {
        Optional<Product> found = productRepository.findById(id);
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> exposeList(ListIdsRequestDTO request) {
        List<Product> foundProducts = productRepository.findAllById(request.ids());
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> softDeleteOne(Integer id) {
        Optional<Product> found = productRepository.findById(id);
    ...
    @Override
    public GlobalResponseDTO<NoPaginatedMeta, Void> softDeleteList(ListIdsRequestDTO request) {
        List<Product> foundProducts = productRepository.findAllById(request.ids());
